...
''' main directory specified by the user
Public mainDir As String
''' A collection of all subfolders below mainDir
...
''''
' Create a collection of all subdirectories below Directory
''''
Public Function ListDirectories(colFolders As Collection, StrFolder As Variant)
    Dim strTemp As String
    Dim Folder As Variant
    Dim colLocFolders As New Collection
    strTemp = Dir(StrFolder, vbDirectory)
    Do While strTemp <> vbNullString
        If (strTemp <> ".") And (strTemp <> "..") Then
            If (GetAttr(StrFolder & strTemp) And vbDirectory) <> 0 Then
                colLocFolders.Add StrFolder & strTemp & "\"
    ...
    For Each Folder In colLocFolders
        ListDirectories colFolders, Folder
    Next Folder
End Function


''''
' Create a list of all subdirectories below Directory
''''
Public Function ListDir()
    Dim colFolders As New Collection
    ListDirectories colFolders, "C:\Antonio\"
