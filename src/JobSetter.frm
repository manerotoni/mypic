...
On Error GoTo AcquireJobIndex_Error
    ...
    AcquireJob index, ImgJobs(index), GlobalRecordingDoc, ImgJobs(index).Name, position, tsk
   On Error GoTo 0
   Exit Sub
...
On Error GoTo AddImgJobFromFile_Error
    ...
    AddJob ImgJobs, JobName, ImgJobList.ListCount - 1, getRecordingFromImageFile(FileName, JobName, ZEN), ZEN
